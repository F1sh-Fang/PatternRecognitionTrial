...
class UNetModel(nn.Module):
    def __init__(self, IMG_HEIGHT, IMG_WIDTH, IMG_CHANNELS, out_channels=1):
        ...
        self.encoder2 = self.conv_block(8, 64)
        self.encoder3 = self.conv_block(64, 128)
        self.encoder4 = self.conv_block(128, 256)
        self.encoder5 = self.conv_block(256, 512)

        # 解码器部分 (Decoder)
        self.decoder4_upconv = self.upconv_block(512, 512)
        self.decoder3_upconv = self.upconv_block(256, 256)
        self.decoder2_upconv = self.upconv_block(128, 128)
        self.decoder1_upconv = self.upconv_block(64, 64)

        self.decoder4 = self.conv3_block(768, 256)
        self.decoder3 = self.conv3_block(384, 128)
        self.decoder2 = self.conv3_block(192, 64)
        self.decoder1 = self.conv3_block(72, 8)
